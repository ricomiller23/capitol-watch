...
export const metadata: Metadata = {
  title: 'CAPITOL.WATCH — US Congress: Bills, Votes, Money & Deadlines',
  description: 'Non-partisan legislative dashboard tracking bills, recorded floor roll calls, member defection rates, four separated money regimes, and fiscal cliff countdowns under automated neutrality tests.',
};
